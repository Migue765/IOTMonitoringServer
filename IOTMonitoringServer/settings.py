...
ALLOWED_HOSTS = ["localhost", "3.208.29.215"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "10.0.51.180",  # Dirección IP de la base de datos
...
# Dirección del bróker MQTT (usa la IP pública de la EC2 "IOT-System/MQTT Broker" en AWS)
MQTT_HOST = "3.92.139.241"
