...
#define USER "ma.gomeza1" // TODO Reemplace UsuarioMQTT por un usuario (no administrador) que haya creado en la configuración del bróker de MQTT.
const char MQTT_HOST[] = "3.92.139.241"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
const int MQTT_PORT = 8082;
const char MQTT_USER[] = USER;
// Contraseña de MQTT
const char MQTT_PASS[] = "amarillo"; // TODO Reemplace ContrasenaMQTT por la contraseña correpondiente al usuario especificado.
...
float humi;
// Valor de la medición de luminosidad (0-100 % o lx según conversión)
float lumi;
...
/**
 * Publica temperatura, humedad y luminosidad al tópico configurado usando el cliente MQTT.
 */
...
/**
 * Lee la luminosidad del LDR en el pin LDR_PIN.
 * ADC 0-4095 (ESP32) se mapea a 0-100 (porcentaje de luz).
 * Más luz -> mayor valor en el ADC -> mayor porcentaje.
 */
...
/**
 * Agrega los valores medidos de temperatura, humedad y luminosidad a la pantalla.
 */
...
/**
 * Mide temperatura, humedad y luminosidad y las envía si es momento.
 */
void measure() {
